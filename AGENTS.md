...
- Skill/task catalog lives in `/.agents/skills/feature-request/SKILL.md`.
...
- Keep `/.agents/skills/feature-request/SKILL.md` as the canonical skill/task flow document.
