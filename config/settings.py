...
FEATURE_REQUEST_API_BASE_URL = os.getenv(
    "FEATURE_REQUEST_API_BASE_URL",
...
FEATURE_REQUEST_MCP_SERVER_URL = os.getenv(
    "FEATURE_REQUEST_MCP_SERVER_URL",
    f"http://{FEATURE_REQUEST_MCP_HOST}:{FEATURE_REQUEST_MCP_PORT}/mcp",
)
FEATURE_REQUEST_MCP_AUTH_ISSUER_URL = os.getenv(
    "FEATURE_REQUEST_MCP_AUTH_ISSUER_URL",
    "http://127.0.0.1:8000",
)
FEATURE_REQUEST_MCP_API_TIMEOUT_SECONDS = float(
    os.getenv("FEATURE_REQUEST_MCP_API_TIMEOUT_SECONDS", "20")
)
